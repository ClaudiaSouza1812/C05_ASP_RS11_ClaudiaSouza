...
namespace D04_MVC_NET_Core_DatabaseFirst.Controllers
{
    ...
    {
        private readonly ContactDB_EFCore_DBFirst_ClaudiaSouzaContext _context;

        public AddressController(ContactDB_EFCore_DBFirst_ClaudiaSouzaContext context)
        {
            _context = context;
        }
        ...
        {
            var contactDB_EFCore_DBFirst_ClaudiaSouzaContext = _context.Addresses.Include(a => a.Contact);
            return View(await contactDB_EFCore_DBFirst_ClaudiaSouzaContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContactDB_EFCore_DBFirst_ClaudiaSouzaContext.Addresses'  is null.");
            }
            var address = await _context.Addresses.FindAsync(id);
            if (address != null)
            {
